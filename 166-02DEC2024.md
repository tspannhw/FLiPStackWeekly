...
🕶️ [Airflow with Snowflake](https://www.astronomer.io/docs/learn/airflow-snowflake/)<br/>
...
🕶️ [LLM Observability OSS](https://github.com/Helicone/helicone)<br/>
🕶️ [NV Ingest from NVIDIA for PDF](https://github.com/NVIDIA/nv-ingest)<br/>
