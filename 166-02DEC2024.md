...
[GO and Java - Type Safety](https://rohan.ga/blog/java-go/)<br/>
[AG2 Agents](https://github.com/ag2ai/ag2)<br/>
[Microsoft's updated AUTOGEN Agents](https://microsoft.github.io/autogen/dev/user-guide/agentchat-user-guide/tutorial/agents.html)<br/>
[LLAMAINDEX resume cookbook](https://github.com/run-llama/llamacloud-demo/blob/main/examples/resume_matching/resume_matching.ipynb)<br/>
